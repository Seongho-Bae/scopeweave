...
**Learning:** Creating complex static DOM trees structure repeatedly inside a high-frequency tight rendering loop (like O(N) table row generations) causes unnecessary DOM manipulation overhead and can severely degrade performance in vanilla JS.
